...
ASSETS COMMANDS
  bttc          BTTC related commands, e.g. swap between BTT and WBTT
  vault         Vault reladted commands, e.g. deposit WBTT to your vault
  cheque        Cheque related commands, e.g. list cheques you have received
